...
import { otpUser } from "../api/authApi";
  ...
  return (
    <div className="w-full h-[100vh] flex justify-center items-center bg-slate-600">
      <div className="w-[300px] h-[300px] shadow-md rounded-md bg-white flex items-center justify-center flex-col p-3">
        ...
        <button className="w-full h-[40px] hover:cursor-pointer transition-all duration-300 bg-black text-white rounded-md mb-[15px] mt-[20px] text-[17px]" onClick={()=>{
